 ...
 */
@Immutable
public class ElectionCryptoContext implements ElectionContext {
   ...
   */
  public static ElectionCryptoContext create(
  ...
  public ElectionCryptoContext(int numberOfGuardians, int quorum, Group.ElementModP jointPublicKey,
  ...
  public boolean equals(Object o) {
    ...
    ElectionCryptoContext that = (ElectionCryptoContext) o;
