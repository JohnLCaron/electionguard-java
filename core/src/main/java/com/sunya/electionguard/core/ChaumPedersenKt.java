...
public class ChaumPedersenKt {
  ...
  public record ConstantChaumPedersenProofKnownNonce(
    ...
    public boolean isValid(
      ...
      return proof.isValid(
              ...
              hashHeader,
              Arrays.asList(ciphertext.pad(), ciphertext.data()),
              true
  ...
  public static ConstantChaumPedersenProofKnownNonce constantChaumPedersenProofKnownNonceOf(
    ...
    return new ConstantChaumPedersenProofKnownNonce(
            genericChaumPedersenProofOf(
                    ...
                    seed,
                    hashHeader,
                    List.of(message.pad(), message.data())
            ),
            plaintext
    );
  }
   ...
   * @param hashHeader Usually the election extended base hash (Q')
  ...
  public static GenericChaumPedersenProof genericChaumPedersenProofOf(
          ElementModP g,  // G ?
          ElementModP h,  // A = G^r
          ElementModQ x,  // secret key s
          ElementModQ seed,
          ElementModQ hashHeader,
          List<Object> alsoHash) {
    ...
    List<Object> hashElems = Lists.newArrayList(hashHeader, a, b);
    hashElems.addAll(alsoHash);
  ...
  public record GenericChaumPedersenProof(ElementModQ c, ElementModQ r) {
     ...
     * @param h See above.
     * @param hx See above.
     * @param hashHeader the election extended base hash (Q')
     * @param alsoHash Optional additional values to include in the hash challenge computation hash
