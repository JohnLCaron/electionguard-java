 ...
 */
public class RunDecryptionSimulator2 {
  ...
  public static void main(String[] args) {
    String progName = RunDecryptionSimulator2.class.getName();
    RunDecryptionSimulator2 decryptor;
    ...
    try {
      ...
      decryptor = new RunDecryptionSimulator2(consumer, electionRecord, guardiansProvider);
  ...
  public RunDecryptionSimulator2(Consumer consumer, ElectionRecord electionRecord, RemoteGuardiansProvider provider) {
