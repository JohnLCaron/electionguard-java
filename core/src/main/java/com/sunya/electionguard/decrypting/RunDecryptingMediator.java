 ...
 * </strong>
 */
public class RunDecryptingMediator {
  ...
  public static void main(String[] args) {
    String progName = RunDecryptingMediator.class.getName();
    ...
    boolean allOk = false;
    RunDecryptingMediator decryptor = null;
    try {
      ...
      decryptor = new RunDecryptingMediator(consumer, electionRecord, tallyResult,
  ...
  private class DecryptingRegistrationService extends DecryptingServiceGrpc.DecryptingServiceImplBase {
    ...
    public void registerTrustee(DecryptingProto.RegisterDecryptingTrusteeRequest request,
      ...
      try {
        DecryptingRemoteTrusteeProxy trustee = RunDecryptingMediator.this.registerTrustee(request);
