...
public class TestSchnorrProperties extends TestProperties {
  ...
  public void test_schnorr_proofs_invalid_u(
    ...
    assertThat(proof2.isValidVer1()).isFalse();
  }
  ...
  public void test_schnorr_proof_invalid_h(
    ...
    assertThat(proof_bad.isValidVer1()).isFalse();
  }
  ...
  public void test_schnorr_proofs_bounds_checking(
    ...
    SchnorrProof proof3 = new SchnorrProof(int_to_p_unchecked(Group.getPrimes().largePrime),
            proof.commitment, proof.challenge, proof.response);
    assertThat(proof2.isValidVer1()).isFalse();
    assertThat(proof3.isValidVer1()).isFalse();
  }
