...
public class FakeBallotProvider implements BallotProvider {
  ...
  private static class BallotFactory {
    PlaintextBallot get_fake_ballot(ElectionWithPlaceholders metadata, String ballot_id) {
    ...
    PlaintextBallot.Contest get_random_contest_from(Election.ContestDescription contest) {
      int voted = 0;
    ...
    static PlaintextBallot.Selection get_random_selection_from(Election.SelectionDescription description) {
