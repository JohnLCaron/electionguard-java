...
public class RunStandardWorkflow {
  public static final String classpath = "build/libs/electionguard-java-0.9.4-SNAPSHOT-all.jar";
  ...
  public static void main(String[] args) {
    ...
    command0.run(out, "java",
            "-classpath", classpath,
            "com.sunya.electionguard.standard.PerformKeyCeremony",
            "-in", cmdLine.inputDir,
    ...
    command2.run(out, "java", "-classpath", classpath,
            "com.sunya.electionguard.standard.DecryptBallots",
            "-in", cmdLine.encryptDir,
