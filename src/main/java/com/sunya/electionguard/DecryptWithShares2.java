...
class DecryptWithShares2 {
  ...
  static Optional<List<DecryptionMediator2.SpoiledBallotAndTally>> decrypt_spoiled_ballots(
    ...
    List<DecryptionMediator2.SpoiledBallotAndTally> result = new ArrayList<>();
    for (CiphertextAcceptedBallot ballot : ballots) {
      ...
      result.add(new DecryptionMediator2.SpoiledBallotAndTally(dtally, dballot));
    }
