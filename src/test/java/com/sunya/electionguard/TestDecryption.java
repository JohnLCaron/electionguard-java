...
public class TestDecryption extends TestProperties {
  ...
  public void test_compute_compensated_decryption_share() {
    ...
    KeyCeremony.ElectionPublicKey missing_guardian_public_key = missing_guardian.share_election_public_key();
  ...
  public void test_compute_compensated_selection() {
    ...
    KeyCeremony.ElectionPublicKey available_guardian_1_key = available_guardian_1.share_election_public_key();
    KeyCeremony.ElectionPublicKey available_guardian_2_key = available_guardian_2.share_election_public_key();
    KeyCeremony.ElectionPublicKey missing_guardian_key = missing_guardian.share_election_public_key();
  ...
  public void test_compute_compensated_selection_failure() {
    ...
    KeyCeremony.ElectionPartialKeyBackup incorrect_backup 
  ...
  public void test_reconstruct_decryption_share() {
    ...
    KeyCeremony.ElectionPublicKey missing_guardian_key = missing_guardian.share_election_public_key();
    Map<String, KeyCeremony.ElectionPartialKeyBackup> missing_guardian_backups = missing_guardian.share_election_partial_key_backups().stream()
  ...
  public void test_reconstruct_decryption_shares_for_ballot() {
    ...
    Map<String, Group.ElementModQ> lagrange_coefficients = Decryptions.compute_lagrange_coefficients_for_guardians(available_guardians_keys);
